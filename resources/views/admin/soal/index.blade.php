...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('kuis.soal_action',Request::segment(2))}}" method="POST" enctype="multipart/form-data">
            @csrf
                <div class="card">
                    <div class="card-body">
                                    ...
                                    <div class="pt-0">
                                        ...
                                        <div class="settings-form">
                                            <div class="form-group">
                                                ...
                                                <img id="img-mmk" src="https://via.placeholder.com/800x300" alt=""
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea placeholder="Masukan Pertanyaan..." name="name"
                                                    class="form-control pt-3" style="min-height: 150px;"></textarea>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div id="pilihan-view" style="display:none">
                                                <div class="input-group mt-3">
                                                    ...
                                                    <input type="text" name="a"
                                                        placeholder="Jawaban 1..." class="form-control">
                                                </div>
                                                <div class="input-group mt-3">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">
                                                    ...
                                                    <input type="text" name="b" 
                                                        placeholder="Jawaban 2..." class="form-control">
                                                </div>
                                                <div class="input-group mt-3">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">
                                                    ...
                                                    <input type="text" name="c" 
                                                        placeholder="Jawaban 3..." class="form-control">
                                                </div>
                                                <div class="input-group mt-3">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">
                                                    ...
                                                    <input type="text" name="d"   
                                                        placeholder="Jawaban 4..." class="form-control">
                                                </div>
                                                <div class="form-group">
...
<script>
    $(function () {
        $('#json-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route('kuis.soal_json',Request::segment(2))}}',
            columns: [{
                    data: 'id',
                    name: 'id'
                },
