...
<div class="container-fluid">
    <div class="row">
        <form action="{{route('admin.quizzes.update', $quiz->id)}}" method="POST" class="col-xl-12" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="col-xl-12">
                                    ...
                                    <div class="pt-3">
                                        <div class="settings-form">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" value="{{$quiz->name}}" placeholder="Masukan Judul..." class="form-control">
                                            </div>

                                            <div class="form-group">
                                                <label>Nilai Per Soal</label>
                                                <input type="text" name="soal_value" value="{{$quiz->soal_value}}" placeholder="Masukan Nilai Per Soal..." class="form-control">
                                            </div>

                                            <div class="form-group">
                                                <label for="attachments[]">Attachments</label>
                                                <div class="input-group" id="attachments-input" @if (!empty($quiz->attachments)) style="display: none;"@endif>
                                                ...
                                                <div class="previous-attachment mb-3">
                                                    <a href="{{ $quiz->getAttachmentFileUrl($attachment) }}" download=""><i class="fa fa-paperclip"></i> {{$attachment}}</a>
                                                </div>
                                                @endforeach
