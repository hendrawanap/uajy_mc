...
<div class="container-fluid">
    <div class="row">
        <!-- Form -->
        <form action="{{route('user.store')}}" method="POST" class="col-xl-12">
        @csrf
            <div class="col-xl-12">
                <!-- Title -->
                                        ...
                                        <div class="settings-form">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="password" name="password_confirmation" placeholder="Masukan Konfirmasi Password..." required
                                                        class="form-control">
                                                </div>
                                            </div>
