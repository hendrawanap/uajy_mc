...
<div class="container-fluid">
    ...
    <div class="row mb-5 align-items-center">
        ...
        <div class="col-lg-3 mb-4 mb-lg-0">
            ...
            <a href="{{route('user.create')}}" class="btn btn-primary light btn-lg btn-block rounded shadow px-2">+ Tambah
        ...
        <div class="total-peserta col-lg-9 d-flex justify-content-end">
            ...
            <div class="d-flex justify-content-start align-items-end">
                ...
                <div>
                    ...
                    <h3 class="mb-0 text-black font-w600 fs-20">{{\App\User::where('isAdmin',0)->count()}} Orang</h3>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="table-responsive">
                ...
                <table id="json-table" class="table display mb-4  fs-14">
