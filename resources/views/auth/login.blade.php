                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center mb-3 my-n2">
                                        <img src="/logo/dagangan biru.png" width="75" style="margin: 0px 5px"/>
                                        <img src="/logo/monggo_logo_1.png" width="75" style="margin: 0px 5px"/>
                                        <img src="/logo/Logo Sariayu.jpg" width="75" style="margin: 0px 5px"/>
                                    </div>
                                    @endif
