...
<head>
    ...
    <title>Management Competition - Hasil Kerja</title>
    <!-- Favicon icon -->
			...
			<div class="container-fluid">
                <div class="row mb-5 align-items-center">
					<div class="col-lg-3 mb-4 mb-lg-0">
						<a href="buat-uploader.php" class="btn btn-primary light btn-lg btn-block rounded shadow px-2">+ Buat Uploader</a>
					</div>
					<div class="total-peserta col-lg-9 d-flex justify-content-end">
						<div class="d-flex justify-content-start align-items-end">
							...
							<div>
								<p class="mb-1 fs-14">Total Hasil Kerja</p>
								<h3 class="mb-0 text-black font-w600 fs-20">2 Uploader</h3>
							</div>
						</div>
					</div>	
				</div>
                                ...
                                <div class="media ai-icon">
                                    ...
                                    <div class="media-body d-flex align-items-end justify-content-between">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <a href="edit-uploader.php"><span class="badge badge-warning">Edit Uploader</span></a>
                                            <a href="set-uploader.php"><span class="badge badge-primary">Set Uploader</span></a>
                                            <a href="lihat-uploader.php"><span class="badge badge-success">Lihat Submit</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
