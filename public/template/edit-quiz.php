...
<head>
    ...
    <title>Management Competition - Edit Quiz</title>
    <!-- Favicon icon -->
                    ...
                    <form action="" class="col-xl-12">
                        <div class="col-xl-12"> 
                            ...
                            <div class="d-flex justify-content-start align-items-center mb-4">
                                ...
                                <h4 class="text-primary ml-2 mt-2">Edit Quiz</h4>
                            </div>
                            <!-- Repeat Soal -->
                            <div class="card">
                                <div class="card-body">
                                    <div class="profile-tab">
                                        <div class="custom-tab-1">
                                            <div id="profile-settings">
                                                <div class="pt-0">                    
                                                    <!-- Judul Soal -->
                                                    <label style="font-size: 20px; color: #000; margin-bottom: 25px;">Soal 1</label>
                                                    <!-- Btn Hapus Soal -->
                                                    ...
                                                    <div class="settings-form">
                                                        <div class="form-group">
                                                            ...
                                                            <img src="images/profile/8.jpg" alt="" class="img-fluid mb-3" style="height: 100px; width: auto; border-radius: 15px;">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" placeholder="Masukan Pertanyaan..." class="form-control">
                                                        </div>
                                    ...
                                    <div class="profile-tab">
                                        <div class="custom-tab-1">
                                            <div id="profile-settings">
                                                <div class="pt-0">                    
                                                    <!-- Judul Soal -->
                                                    <label style="font-size: 20px; color: #000; margin-bottom: 25px;">Soal 2</label>
                                                    <!-- Btn Hapus Soal -->
                                                    <a class="menu-delete-soal ml-4 sweet-confirm" style="cursor: pointer;">
                                                        <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M3.50195 5.99994H5.5156H21.6248" stroke="#A0A0A0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
