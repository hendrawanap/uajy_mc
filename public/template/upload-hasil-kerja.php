...
<head>
    ...
    <title>Management Competition - Upload Hasil Kerja</title>
    <!-- Favicon icon -->
...
<body>
                    ...
                    <form action="" class="col-xl-12">
                        <div class="col-xl-12"> 
                            ...
                            <div class="d-flex justify-content-start align-items-center mb-4">
                                ...
                                <h4 class="text-primary ml-2 mt-2">Upload Hasil Kerja</h4>
                            </div>
                            <!-- Repeat Soal -->
                            <div class="card">
                                <div class="card-body">
                                    <div class="profile-tab">
                                        <div class="custom-tab-1">
                                            <div id="profile-settings">
                                                <div class="pt-0">
                                                    <h3 class="judul">Uploader Semifinal</h3>
                                                    <p class="mb-3">
    ...
    ***********************************-->
	...
	<script>
		...
		$('.metismenu li:nth-child(6)').addClass('mm-active');
	</script>	
