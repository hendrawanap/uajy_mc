...
<head>
    ...
    <title>Management Competition - Submit Hasil Kerja</title>
    <!-- Favicon icon -->
                                        ...
                                        <div class="card-body p-4">
                                            <div class="media ai-icon statss">
                                                ...
                                                <div class="media-body d-flex align-items-end justify-content-between">
                                                    <div>
                                                        <h4 class="mt-1" style="color: #000;">Semifinal</h4>
                                                        <p class="mb-0">
                                                    ...
                                                    <div class="d-flex justify-content-end">
                                                        <a href="upload-hasil-kerja.php"><span class="badge badge-success">Upload</span></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="widget-stat card">
                                        <div class="card-body p-4">
                                            <div class="media ai-icon statss">
                                                ...
                                                <div class="media-body d-flex align-items-end justify-content-between">
                                                    <div>
                                                        <h4 class="mt-1" style="color: #000;">Final</h4>
                                                        <p class="mb-0">
                                                            <i class="fa fa-clock-o"></i>
                                                            90 Menit
                                                        </p>
