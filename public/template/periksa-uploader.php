...
<head>
    ...
    <title>Management Competition - Periksa Hasil Kerja</title>
    <!-- Favicon icon -->
                                    ...
                                    <div class="profile-tab">
                                        <div class="custom-tab-1">
                                            <div id="profile-settings">
                                                <div class="pt-0">
                                                    <div class="w-cont">
                                                        <h3 class="judul">Ini hasil file yang telah diupload peserta kak, dan ini bisa didownload oleh ADMIN</h3>
