...
<head>
    ...
    <title>Management Competition - Tambah Peserta</title>
    <!-- Favicon icon -->
...
<body>
                    ...
                    <form action="" class="col-xl-12">
                        <div class="col-xl-12">
                            ...
                            <div class="d-flex justify-content-start align-items-center mb-4">
                                ...
                                <h4 class="text-primary ml-2 mt-2">Tambah Peserta</h4>
                            </div>
                            <!-- Input -->
                            <div class="card">
                                <div class="card-body">
                                                ...
                                                <div class="pt-3">
                                                    <div class="settings-form">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" placeholder="Masukan Username..." class="form-control">
                                                        </div>
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="password" placeholder="Masukan Konfirmasi Password..." class="form-control">
                                                            </div>
                                                        </div>
                                                        <button class="btn btn-success" type="submit">Buat Peserta</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    ***********************************-->
	...
	<script>
		...
		$('.metismenu li:nth-child(2)').addClass('mm-active');
	</script>	
</body>
</html>