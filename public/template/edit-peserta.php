...
<head>
    ...
    <title>Management Competition - Edit Peserta</title>
    <!-- Favicon icon -->
					...
					<form action="" class="col-xl-12">
                        <div class="col-xl-12">
                            ...
                            <div class="d-flex justify-content-start align-items-center mb-3">
                                ...
                                <h4 class="text-primary ml-2 mt-2">Edit Peserta</h4>
                            </div>
                            <!-- Input -->
                            <div class="card">
                                <div class="card-body">
                                            ...
                                            <div id="profile-settings">
                                                <div class="pt-3">
                                                    <div class="settings-form">
                                                        ...
                                                        <button class="btn btn-success" type="submit">Update Peserta</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
